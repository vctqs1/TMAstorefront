...
<html>
    <head>
        <meta charset="utf-8">
        <title>Demo</title>
        <link href="../web/css/product_by_sub_cate.css" rel="stylesheet" type="text/css" />
        ...
        <div class="container">
        	<div class="row">
        		<div class="col-md-3 col-sm-6 col-xs-4">
		            <?php
		                include('product_by_sub_cate/left-cat.php');
		            ?>
		        </div>
		        <div class="col-md-9 col-sm-6 col-xs-4">
                    <div class="row">
                	<?php
                        include('product_by_sub_cate/banner-top.php');
                    ?>
                    </div>
                    <div class="row">
                    <?php
                        include ('product_by_sub_cate/product-content.php')
                    ?>
                    </div>
                    <div class="row">
                     <?php
                        include ('product_by_sub_cate/product-content2.php')
                    ?>
                    </div>
		        </div>
              <div class="row">
                <div class="col-md-12 col-sm-6 col-xs-4">
                     <?php
                        include ('product_by_sub_cate/Slide-pic.php')
                    ?>
                </div>
              </div>  
            <div class="row">
                <div class="col-md-12 col-sm-6 col-xs-4">
                    <?php
                         include ('product_by_sub_cate/bot-pic.php')
                    ?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-6 col-xs-4">
                <?php
                    include ('product_by_sub_cate/last-para.php')
                ?>
                </div>
            </div>
          </div> 
